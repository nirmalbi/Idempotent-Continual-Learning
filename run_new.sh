...
do
    ...
    python main.py --model="derloss" --load_best_args --dataset="seq-cifar10" --device="cuda:5" --seed=$SEED --n_tasks=$N_TASKS --buffer_size=500 --run_name="derlossplot seed $SEED $N_TASKS tasks" --experiment_name="seq-cifar10"
    done
done